...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'e3@bravexist.cn',
  ...
  footer:
    'Powered by <a href="https://github.com/lightsky9627/onedrive-cf-index-ng" target="_blank" rel="noopener noreferrer">onedrive-cf-index-ng</a>. Made with ❤ by 浅空',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/Private', '/Video/YouTube', '/Documents/zhihu/评论区不可见'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:admin@bravexist.cn',
